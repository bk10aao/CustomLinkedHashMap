...
@Fork(3)
public class CustomLinkedHashMapPerformanceBenchmark {
    ...
    @Benchmark
    public CustomLinkedHashMap<Integer, String> benchmarkConstructor() {
        return new CustomLinkedHashMap<>();
    }
    ...
    public String benchmarkPut() {
        CustomLinkedHashMap<Integer, String> m = new CustomLinkedHashMap<>();
        for (int i = 0; i < size; i++) {
    ...
    public boolean benchmarkEquals() {
        CustomLinkedHashMap<Integer, String> other = new CustomLinkedHashMap<>();
        for (int i = 0; i < size; i++) {
            other.put(i, "Value" + i);
        }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(CustomLinkedHashMapPerformanceBenchmark.class.getSimpleName())
                .forks(3)
                .result("custom-linked-hash-map-results.csv")
    ...
    private static void writeCustomCsv(Collection<RunResult> results) {
        try (FileWriter writer = new FileWriter("CustomLinkedHashMap_jmh_performance.csv")) {
            ...
            System.out.println("JMH Performance report saved: CustomLinkedHashMap_jmh_performance.csv");
        } catch (IOException e) {
